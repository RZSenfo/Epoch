/*
    ...
    Github:
    https://github.com/EpochModTeam/Epoch/tree/release/Sources/epoch_server_settngs/configs/maps/stratis.h
*/
class Stratis : Default
{
	...
	allowedVehiclesList_CUP[] = {
		...
		{"CUP_C_SUV_CIV",1},
		{"CUP_B_HMMWV_Transport_USA",1},
		{"CUP_B_HMMWV_Unarmed_USA",1},
		{"CUP_C_SUV_TK",1},
		{"CUP_B_LR_Transport_CZ_D",1},
		...
		{"CUP_C_Ural_Civ_02",1},
		{"CUP_B_TowingTractor_USMC",1},
		{"CUP_C_C47_CIV",1},
		{"CUP_B_LR_Transport_CZ_W",1},
		...
		{"CUP_B_HMMWV_Ambulance_USA",1},
		{"CUP_C_UAZ_Unarmed_TK_CIV",1},
		{"CUP_C_UAZ_Open_TK_CIV",1},
		{"CUP_B_UAZ_Unarmed_CDF",1},
